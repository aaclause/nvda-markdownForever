...
* "Allow Extratags back translation": This will indicate whether or not [extra-tags](#extra-tags) should be reverted to their original form (e.g. 7/19/2020) when converting an HTML content generated by Markdown Forever back to Markdown. 
...
* extratags-back: To indicate whether or not [extra-tags](#extra-tags) should be reverted to their original form (e.g. 7/19/2020) when converting an HTML content generated by Markdown Forever back to Markdown. Possible values: true (1) or false (0).
...
| :----------: | :----------: | :----------: |
| `%date%` | Current date | 7/19/2020 |
| `%time%` | Current time | 3:02:06 PM |
| `%now%` | Current date / time | 7/19/2020 3:02:06 PM |
| `%day%` | Current day (long format) | Sunday |
| `%dday%` | Current day (decimal format) | 19 |
