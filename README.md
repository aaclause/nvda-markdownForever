...
* "Allow Extratags back translation": This will indicate whether or not [extra-tags](#extra-tags) should be reverted to their original form (e.g. 7/20/2020) when converting an HTML content generated by Markdown Forever back to Markdown. 
...
* extratags-back: To indicate whether or not [extra-tags](#extra-tags) should be reverted to their original form (e.g. 7/20/2020) when converting an HTML content generated by Markdown Forever back to Markdown. Possible values: true (1) or false (0).
