...
* "Try to automatically number headings": I checked, Markdown Forever will attemps to prefix your headings (or chapters) by numbers, according to the level of each heading, E.G. "1." for heading level 1, "1.1." for heading level 2 etc. 
...
* autonumber-headings: To indicate whether or not headings should be numbered automatically.
...
* extratags-back: To indicate whether or not [extra-tags](#extra-tags) should be reverted to their original form (e.g. %date%) when converting an HTML content generated by Markdown Forever back to Markdown.
* filename: to indicate the name of the output file when saving.
* keywords: To specify keywords related to the topic covered by your document.
