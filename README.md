...
screen in Tab order:
  ...
  * "Allow Extratags back translation": This will indicate whether or not extra-tags should be reverted to their original form (e.g. %date%) when converting an HTML content generated by Markdown Forever back to Markdown. 
...
beginning of the document and must begin with three dashes (" _-") and end
with three periods ("...") or three dashes ("_ -"). Each entry must be
...
### List of supported metadata
  ...
  * extratags-back: To indicate whether or not extra-tags should be reverted to their original form (e.g. %date%) when converting an HTML content generated by Markdown Forever back to Markdown. Possible values: true (1) or false (0).
...
>     ---
>  
>     Hello world! <span lang="fr">Bonjour le monde !</span> <span
> lang="es">¡Hola mundo!</span>
...
---|---|---  
`%date%` | Current date | 7/18/2020
`%time%` | Current time | 1:56:25 AM
`%now%` | Current date / time | 7/18/2020 1:56:25 AM 
`%day%` | Current day (long format) | Saturday
`%dday%` | Current day (decimal format) | 18
...
## Add-on Information
  ...
  * Authors: 
    * André <[dev@andreabc.net](mailto:dev@andreabc.net)>: creator and main maintainer of the add-on.
    * Sof <[hellosof@gmail.com](mailto:hellosof@gmail.com)>: English and French documentation, various suggestions.
    * Victor Cai: Chinese localization.
    * Çağrı Dogan: Turkish localization.
    * Rémy Ruiz <[remyruiz@gmail.com](mailto:remyruiz@gmail.com)>: Spanish localization.
    * Dang Manh Cuong <[dangmanhcuong@gmail.com](mailto:dangmanhcuong@gmail.com)>: Vietnamese localization.
    * And much more!
